...
Напишите функцию `partition`, которая принимает массив и предикат (функцию), возвращающую логическое значение. 

Функция должна разделять элементы массива на два подмассива: один для элементов, которые удовлетворяют предикату, и другой для элементов, которые не удовлетворяют. Возвращаемый результат должен быть массивом из двух массивов.
...
- `test/partition.js` &mdash; файл с тестами к функции `partition()`
